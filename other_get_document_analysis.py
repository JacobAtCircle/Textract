...
import shutil
import numpy as np
from other_document_functions import *
...
shutil.rmtree('JSON Responses Location', ignore_errors=True)



#Loads the map of JobID: filename key-value pairs
#Commenting out for testing
job_id_dict = load_json_file('other_start_document_analysis.txt')
